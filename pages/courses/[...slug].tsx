      ...
      course.lessons.map(async (lesson) => {
        if (lesson?.video?.publicPlaybackId) {
          try {
            ...
            console.error(`Failed to fetch blurhash for lesson ${lesson.id}:`, error);
            // Optionally set a default placeholder or leave it undefined
            // (lesson.video as VideoWithPlaceholder).placeholder = 'default_placeholder_value';
          }
        }
        return lesson;
      })
